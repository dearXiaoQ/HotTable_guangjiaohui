...
public class ab_IndControlActivity extends Activity {
            ...
            if (result == GizWifiErrorCode.GIZ_SDK_SUCCESS) {
                ...
                if (sn == INDCOOKER_SN) {
                    ...
                    if (dataMap.get("data") != null) {
                        ...
                        Toast.makeText(ab_IndControlActivity.this,
    ...
    private void setControlLinstener() {
        ...
        backIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ab_IndControlActivity.this.finish();
            }
        });
        ...
        testBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (devices.size() == 0) {
                    Toast.makeText(ab_IndControlActivity.this, deviceTipInfo, Toast.LENGTH_SHORT).show();
                    return;
                }
                GizWifiDevice dev = devices.get(0);
                dev.setSubscribe(true);
        ...
        stickySwitch.setOnSelectedChangeListener(new StickySwitch.OnSelectedChangeListener() {
            ...
            public void onSelectedChange(@NotNull StickySwitch.Direction direction, @NotNull String text) {
                ...
                if(direction.name() == RIGHT) {
                    stickySwitch.setSwitchColor(ab_IndControlActivity.this.getResources().getColor(R.color.pinkSwitchColor));
                } else {
                    stickySwitch.setSwitchColor(ab_IndControlActivity.this.getResources().getColor(R.color.graySwitchColor));
                }
            }
        });
